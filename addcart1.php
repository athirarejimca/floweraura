    ...
    <div id="menu">
      <ul>
       <li><a href="userhome.php">Home</a></li>
        ...
        <li class="selected"><a href="moredetails.php">Flowers</a></li>
	   ...
	   <?php
                        ...
                        $sql1=mysqli_query($con,"SELECT * FROM flower f,product p  where f.pid=p.pid and fid='$id'");
...
?>     
	...
	<form id="form2" name="form2" method="post" action="addcart1.php">
	<div class="f1">
	<img src="<?php echo $t['photo']?>" width="300px" height="200px" /></div>
<br><br><br> 
		<div class="f2">
       <table>
<tr></tr>
                            ...
                            <tr>
                               <td>Description</td> <td>:</td><td><input type="text" name="editage" value="<?php echo $t['description']; ?>" required readonly="readonly"/></td>
                            </tr>
                            <tr>
...
$sql2=mysqli_query($con,"SELECT * FROM flower f,product p where f.pid=p.pid and f.fid=$id;");
...
<script>window.location.href="userview.php"</script>
<?php
...
$S=$q1-$q;
//echo $S;
$sql11="update flower set quantity='$S' where fid='$id'";
$result11=mysqli_query($con,$sql11) or die(mysqli_error($con));

$sql="INSERT INTO `cart`(`p_id`, `quantity1`, `total`, `regid`,`date`,`status`) VALUES  ('$r','$q','$p','$s','$d','0')";
